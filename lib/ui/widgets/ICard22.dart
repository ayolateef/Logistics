...
import 'package:courierx_owner/ui/widgets/ibutton2.dart';
...
class _ICard22State extends State<ICard22> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.text4Style != null) _text4Style = widget.text4Style;
    if (widget.text5Style != null) _text5Style = widget.text5Style;
    if (widget.text6Style != null) _text6Style = widget.text6Style;
    if (widget.text7Style != null) _text7Style = widget.text7Style;
    if (widget.text6Style != null) _text7Style = widget.text7Style;
    if (widget.button1Style != null) _button1Style = widget.button1Style;
    if (widget.button2Style != null) _button2Style = widget.button2Style;
    if (widget.button3Style != null) _button3Style = widget.button3Style;
    if (widget.button4Style != null) _button4Style = widget.button4Style;
    return InkWell(
        onTap: () {
          if (widget.callback != null) widget.callback(widget.id);
        },
        child: Container(
