...
class _IEasyDialog2State extends State<IEasyDialog2> {
  late DragUpdateDetails _detailsStart;
  late DragUpdateDetails _detailsEnd;
                ...
                if (_rowKey.currentContext != null)
                  {
                    _needRedraw = true,
                    _rowHeight.value =
                        _rowKey.currentContext?.size?.height ?? 0.0,
                  }
              });
    }
                      ...
                      GestureDetector(
                          ...
                          onVerticalDragEnd: (DragEndDetails details) {
                            ...
                            if (_detailsStart.localPosition != null) {
                              if (_detailsStart.localPosition.dy >
