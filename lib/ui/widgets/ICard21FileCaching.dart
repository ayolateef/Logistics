...
class ICard21FileCaching extends StatefulWidget {
  ...
  const ICard21FileCaching({this.color = Colors.white, this.width = 100, this.height = 100,
...
class _ICard21FileCachingState extends State<ICard21FileCaching>{
  ...
  var _textStyle2 = const TextStyle(fontSize: 16);
  var _textStyle3 = const TextStyle(fontSize: 16);
   ?
