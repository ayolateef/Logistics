...
class ICard29FileCaching extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (titleStyle != null) _titleStyle = titleStyle;
    TextStyle? _textStyle = const TextStyle(fontSize: 16);
    if (textStyle != null) _textStyle = textStyle;
    TextStyle? _dateStyle = const TextStyle(fontSize: 16);
    if (dateStyle != null) _dateStyle = dateStyle;
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.delete,
                          size: 25,
                          color: balloonColor.withOpacity(
                              0.8)), //Text(balloonText, style: _balloonStyle,),
                    ),
                    Container(
                        width: 50,
                        height: 50,
