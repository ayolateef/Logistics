...
class IButtonBorder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? _textStyle = TextStyle(fontSize: 16, color: _color);
      ...
      _row = Row(
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: Flexible(
                  child: Text(text!,
                      overflow: TextOverflow.ellipsis, style: _textStyle))),
        ],
      );
    } else {
      _row = Row(
        ...
        children: <Widget>[
          Container(
              margin:
                  const EdgeInsets.only(left: 10, right: 10, top: 5, bottom: 5),
              child:
                  Text(text!, overflow: TextOverflow.fade, style: _textStyle)),
        ],
      );
    }
    Color? _colorBackgroud = Colors.transparent;
    if (colorBackgroud != null) _colorBackgroud = colorBackgroud;

    var _colorBorder = _color;
    if (border != null && !border!) _colorBorder = Colors.transparent;
