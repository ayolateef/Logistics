...
class _HeaderState extends State<Header> {
  ...
  final _iconMenu = "assets/menu.png";
  final _iconBack = "assets/back.png";
  final _iconNotify = "assets/notifyicon.png";
  final _iconChat = "assets/chat.png";
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.white) _style = theme.text16boldWhite;
    ...
    if (widget.transparent) _box = const BoxDecoration();
  ...
  _avatarget(String avatar) {
    if (avatar == '') {
      ...
      const Color colorProgressBar = Colors.black;
