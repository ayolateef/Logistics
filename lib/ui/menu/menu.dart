...
class Menu extends StatelessWidget {
  ...
  Menu(this.context, this.callback, {Key? key}) : super(key: key);
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _item(2, strings.get(25) ?? '',
              "assets/notifyicon.png"), // Notifications
          _item(
              3, strings.get(79) ?? '', "assets/statistics.png"), // Statistics
          ILine(),
          ...
          if (account?.isAuth())
            _item(
                11, strings.get(29) ?? '', "assets/signout.png"), // "Sign Out",
        ],
      ),
    ));
  }
